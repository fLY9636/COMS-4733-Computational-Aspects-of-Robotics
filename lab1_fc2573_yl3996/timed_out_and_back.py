...
class OutAndBack():
	...
	if distance <0:
        ...
        # Move forward for a time to go the desired distaninitce
	...
	# handle user input
    	value = raw_input("input T for Translation, R for Rotation, Q for quit: ")

    	if value == 't' or value == 'T':
    	    translation1 = raw_input("Please input the distance: ")
    	    self.translation(float(translation1))
    	    self.handleInput()
    	elif value == 'r' or value == 'R':
    	    rotation1 = raw_input("please input the degree of angle: ")
    	    self.rotation(float(rotation1))
    	    self.handleInput()
